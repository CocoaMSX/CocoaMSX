...
@class CMSpecialCartNode;

@protocol CMSpecialCartSelectedDelegate <NSObject>
...
@property (nonatomic, assign) NSInteger cartridgeSlot;
@property (nonatomic, assign) BOOL isSelectable;
@property (nonatomic, assign) id <CMSpecialCartSelectedDelegate> delegate;

- (IBAction)dismissChooser:(id)sender;
- (IBAction)selectCartridge:(id)sender;
