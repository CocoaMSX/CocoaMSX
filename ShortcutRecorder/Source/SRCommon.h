...
#define SRLeftShiftMask (NSShiftKeyMask | 0x2)
#define SRRightShiftMask (NSShiftKeyMask | 0x4)
#define SRLeftAlternateMask (NSAlternateKeyMask | 0x20)
#define SRRightAlternateMask (NSAlternateKeyMask | 0x40)
#define SRLeftControlKeyMask  (NSControlKeyMask | 0x1)
#define SRRightControlKeyMask (NSControlKeyMask | 0x2000)
#define SRLeftCommandMask (NSCommandKeyMask | 0x08)
#define SRRightCommandMask (NSCommandKeyMask | 0x10)
