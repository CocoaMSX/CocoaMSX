...
+ (void)initialize
{
    ...
    keyCodeLookupTable = [[NSMutableDictionary alloc] initWithObjectsAndKeys:
                          ...
                          [NSString stringWithFormat:CMLoc(@"Left %C", @"Mac Key"), (unichar)kShiftUnicode],    @0x38,
                          [NSString stringWithFormat:CMLoc(@"Right %C", @"Mac Key"), (unichar)kShiftUnicode],   @0x3c,
                          [NSString stringWithFormat:CMLoc(@"Left %C", @"Mac Key"), (unichar)kControlUnicode],  @0x3b,
                          [NSString stringWithFormat:CMLoc(@"Right %C", @"Mac Key"), (unichar)kControlUnicode], @0x3e,
                          [NSString stringWithFormat:CMLoc(@"Left %C", @"Mac Key"), (unichar)kOptionUnicode],   @0x3a,
                          [NSString stringWithFormat:CMLoc(@"Right %C", @"Mac Key"), (unichar)kOptionUnicode],  @0x3d,
                          [NSString stringWithFormat:CMLoc(@"Left %C", @"Mac Key"), (unichar)kCommandUnicode],  @0x37,
                          [NSString stringWithFormat:CMLoc(@"Right %C", @"Mac Key"), (unichar)kCommandUnicode], @0x36,
