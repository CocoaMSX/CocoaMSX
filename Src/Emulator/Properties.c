...
void propSave(Properties* properties) 
{
    ...
    if (propFile != NULL)
    {
        ...
        //    SET_INT_VALUE_3(propFile, sound, chip, ym2413Oversampling);
        //    SET_INT_VALUE_3(propFile, sound, chip, y8950Oversampling);
        //    SET_INT_VALUE_3(propFile, sound, chip, moonsoundOversampling);
        SET_ENUM_VALUE_3(propFile, sound, YkIn, type, MidiTypePair);
        SET_STR_VALUE_3(propFile, sound, YkIn, name);
        //    SET_STR_VALUE_3(propFile, sound, YkIn, fileName);
        //    SET_STR_VALUE_3(propFile, sound, YkIn, desc);
        ...
        //    SET_STR_VALUE_3(propFile, sound, MidiIn, fileName);
        //    SET_STR_VALUE_3(propFile, sound, MidiIn, desc);
        SET_ENUM_VALUE_3(propFile, sound, MidiOut, type, MidiTypePair);
        SET_STR_VALUE_3(propFile, sound, MidiOut, name);
        //    SET_STR_VALUE_3(propFile, sound, MidiOut, fileName);
        //    SET_STR_VALUE_3(propFile, sound, MidiOut, desc);
