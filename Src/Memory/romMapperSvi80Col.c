...
int romMapperSvi80ColCreate(int frameRate, UInt8* romData, int size)
{
    ...
    ioPortRegister(0x50, NULL,   (IoPortWrite)writeIo, svi80col);
    ioPortRegister(0x51, (IoPortRead)readIo, (IoPortWrite)writeIo, svi80col);
    ioPortRegister(0x58, (IoPortRead)readIo, (IoPortWrite)writeIo, svi80col);
